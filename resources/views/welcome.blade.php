                ...
                <div class="col-md-8"> 
                    <div class="card"> 
                        ...
                        <div class="card-body"> 
                            ...
                            <p>Currently serving <code>{{ number_format($total) }}</code> cat pictures, totalling {{ $size }}, to the world-wide-web. Wanna add a cat picture to the API? Join the <a href="https://discord.gg/ZgPUtcs">Discord Server</a> and upload your image to the <a href="https://discord.gg/ZgPUtcs">#meow</a> channel to get it added!</p>
                        </div> 
                    </div> 
                </div> 
            </div>
